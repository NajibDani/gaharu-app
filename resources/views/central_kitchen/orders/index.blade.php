                                    ...
                                    <div class="action-btn-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-actions">
                                                @if(!$p->wo_status)
                                                    <li>
                                                        <a class="dropdown-item text-dark" href="{{ route('ck-orders.edit', array_merge(['id' => $p->id], request()->query())) }}">
                                            ...
                                            <div class="modal-content border-0 shadow-lg rounded-4">
                                                ...
                                                <div class="modal-footer bg-light py-2 justify-content-between flex-wrap gap-2">
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        ...
                                                        @if(!$p->wo_status)
                                                            <a href="{{ route('ck-orders.edit', array_merge(['id' => $p->id], request()->query())) }}" class="btn btn-warning btn-sm px-3 fw-bold text-dark">
