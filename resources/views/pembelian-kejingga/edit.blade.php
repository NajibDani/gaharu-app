<x-app-layout>
    ...
    <div class="container-fluid px-2 px-md-4 py-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h4 class="m-0 fw-bold text-dark fs-5 fs-md-4">Edit Pembelian Kejingga ({{ $pembelian->kode_pembelian }})</h4>
                <p class="text-muted small mb-0">Ubah item barang, supplier per baris, tanggal, atau harga pembelian.</p>
            </div>
            ...
            <div class="card form-card p-3 mb-3">
                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                    <div>
                        ...
                        <small class="text-muted">Supplier disesuaikan per baris barang</small>
                    </div>
                            ...
                            @foreach($pembelian->details as $idx => $detail)
                                ...
                                <tr class="item-row">
                                    ...
                                    <td data-label="Supplier / Pemasok">
                                        <select name="items[{{ $idx }}][supplier_id]" class="form-select supplier-select">
