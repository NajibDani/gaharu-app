<x-app-layout>
    ...
    <div class="container py-4" style="margin-top: 5.5rem !important; max-width: 1000px;">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold text-dark mb-1">Tambah Permintaan Cold Kitchen</h4>
                <p class="text-muted small mb-0">Input pengajuan permintaan barang / bahan setengah jadi &amp; bahan jadi ke Cold Kitchen</p>
            </div>
        ...
        <form action="{{ route('pesanan.store') }}" method="POST" id="form-cold-order">
            @csrf
            ...
            <div class="card card-form p-4 mb-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="kode_pesanan" class="form-control text-sm rounded-3 bg-light" value="P{{ rand(100,999) }}" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2 mb-5">
                ...
                <button type="submit" class="btn btn-custom-orange shadow-sm px-4">
                    <i class="bi bi-send-fill me-1"></i> Simpan &amp; Kirim Permintaan
                </button>
            </div>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateRowModeOptions(row) {
                ...
                html += `<option value="satuan">Satuan (${satUtama})</option>`;
