<x-guest-layout>
    ...
    @if(session('warning'))
        <div class="alert-status" style="background: rgba(245, 158, 11, 0.15); border: 1px solid #f59e0b; color: #d97706; padding: 12px 16px; border-radius: 10px; margin-bottom: 20px; font-size: 0.9rem; display: flex; align-items: center; gap: 8px;">
