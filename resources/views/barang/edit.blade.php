...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text"
               ...
               value="{{ $data->satuan }}"
               class="form-control"
               required placeholder="Contoh: kg, pcs, liter, gr, ml, porsi">
    ...
    <div class="col-md-6 mb-3">
        <label id="label-satuan-pembelian">Satuan Pembelian (Opsional)</label>
        <input type="text"
               name="satuan_pembelian"
               id="satuan_pembelian"
               value="{{ $data->satuan_pembelian }}"
               class="form-control"
               placeholder="Contoh: botol, dus, karton">
    ...
    <div class="col-md-6 mb-3">
        <label id="label-konversi-pembelian">Konversi Satuan Pembelian (Opsional)</label>
        <input type="number"
               name="konversi_pembelian"
               id="konversi_pembelian"
               value="{{ $data->konversi_pembelian ?? 1 }}"
               class="form-control"
